#!/usr/bin/env python3
# Turn Roy's 94-frame give-order clip into compact atlases and a frame table.
...
# Hold frame 37 steady, keep the lid flip at 24fps, and settle at 12fps.
...
# Ask tex3ds where to split so power-of-two packing doesn't waste a sheet.
import struct
import subprocess
import tempfile
